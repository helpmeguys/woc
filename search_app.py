...
hide_streamlit_style = """
    <style>
        ...
        /* Hide footer (desktop & mobile) */
        footer {visibility: hidden;}
        .st-emotion-cache-1v0mbdj {visibility: hidden;} /* mobile-specific footer class */

        /* Hide header (desktop & mobile) */
        header {visibility: hidden;}
        .st-emotion-cache-18ni7ap {visibility: hidden;} /* mobile-specific header class */
    </style>
