...
# === CONFIGURATION ===
PASSWORD = "templetruth"
REGISTRATION_URL = "https://your-site.com/register"
...
# === OPENAI SETUP ===
client = OpenAI(api_key="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")  # Replace with your OpenAI API key

# === LOAD EMBEDDED DATA ===
@st.cache_data
def load_qa_embeddings(filepath="qa_embeddings.json"):
...
# === MAIN UI ===
st.title("📖 Gospel Q&A Semantic Search")
...
# === FOOTER ===
st.markdown("---")
st.caption("💡 Powered by study, revelation, and the Spirit.")
