...
DOWNLOAD_URL = "https://yourdomain.com/path/to/qa_embeddings.json"  # Replace with your actual URL
...
def ensure_embeddings_file():
    ...
    if not path.exists():
        try:
            ...
            response = requests.get("https://f000.backblazeb2.com/file/megatransfer/vaults/qa_embeddings.json")
